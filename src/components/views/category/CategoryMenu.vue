        ...
        <p class="level level-one">
            ...
            <span class="class">
                ...
                <a class="name" :id="'id' + category_level1.id" :data-level="category_level1.rank"
                    @click="choseLevel(category_level1, $event)" v-for="category_level1 in this.categorys"
                    :key="category_level1.id">{{ category_level1.name }}</a>
            </span>
        </p>
        <p class="level level-two" v-if="sub_category !== undefined">
            ...
            <span class="class">
                ...
                <a class="name" :id="'id' + category_level2.id" :data-level="category_level2.rank"
                    @click="choseLevel(category_level2, $event)" v-for="category_level2 in this.sub_category"
                    :key="category_level2.id">{{ category_level2.name}}</a>
            </span>
        </p>
        <p class="level level-three" v-if="sub_sub_category !== undefined">
            ...
            <span class="class">
                ...
                <a class="name" :id="'id' + category_level3.id" :data-level="category_level3.rank"
                    @click="choseLevel(category_level3, $event)" v-for="category_level3 in this.sub_sub_category"
                    :key="category_level3.id">{{ category_level3.name }}</a>
            </span>
        </p>
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        setDefaultCategory(categoryId) {
            ...
            this.selectedCategory = recursiveCategory(
                this.categorys,
                categoryId
            );
