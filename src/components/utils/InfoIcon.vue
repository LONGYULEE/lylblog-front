<template>
    <div>
        <svg t="1596699259345" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
            p-id="11728" xmlns:xlink="http://www.w3.org/1999/xlink" width="28" height="28">
            <defs>
            ...
            <path
                ...
                p-id="11729" data-spm-anchor-id="a313x.7781069.0.i50" class="" fill="#ffb6c1"></path>
        </svg>
    </div>
</template>
